...
public class Graph {
     ...
     * 判断连通图是否还需要再被划分
     *
     * @param pointList1 坐标点集合1
     * @param pointList2 坐标点集合2
     * @return
     */
